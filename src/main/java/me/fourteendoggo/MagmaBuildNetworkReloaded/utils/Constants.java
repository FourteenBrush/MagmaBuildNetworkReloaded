...
public interface Constants {
    ...
    @Language("SQL") String LOAD_HOMES = "SELECT * FROM homes WHERE owner=?;";
    ...
    @Language("SQL") String DELETE_HOME = "DELETE FROM homes WHERE owner=? AND name=?;";
    @Language("SQL") String[] TABLES = {
